...
declare function ColorOpposite(color: int): [int, int]
...
declare interface drawer_i
{
    ...
    stringWidth(text: string, flags: int, widthtype: string): int
...
declare function CV_RegisterVar(t: table_t): consvar_t
...
declare function searchBlockmap(searchtype: string, fn: Function, refmobj: mobj_t, x1: fixed_t, x2: fixed_t, y1: fixed_t, y2: fixed_t): boolean
...
declare function addHook(hook: "BotAI",fn: (player: mobj_t, bot: mobj_t) => [boolean,boolean,boolean,boolean,boolean,boolean,boolean,boolean], skinname: string): nil
...
declare function addHook(hook: "PlayerQuit",fn: (player: player_t, reason: int) => void): nil
...
declare function addHook(hook: "BossDeath",fn: (mobj: mobj_t) => boolean, objecttype: int): nil
declare function addHook(hook: "BossThinker",fn: (mobj: mobj_t) => boolean, objecttype: int): nil
declare function addHook(hook: "FollowMobj",fn: (player: player_t, followmobj: mobj_t) => boolean, objecttype: int): nil
declare function addHook(hook: "MapThingSpawn",fn: (mobj: mobj_t, mapthing: mapthing_t) => boolean, objecttype: int): nil
declare function addHook(hook: "MobjCollide",fn: (thing: mobj_t, tmthing: mobj_t) => boolean, objecttype: int): nil
declare function addHook(hook: "MobjLineCollide",fn: (mobj: mobj_t, line: line_t) => boolean, objecttype: int): nil
declare function addHook(hook: "MobjDamage",fn: (target: mobj_t, inflictor: mobj_t, source: mobj_t, damage: int, damagetype: int) => boolean, objecttype: int): nil
declare function addHook(hook: "MobjDeath",fn: (target: mobj_t, inflictor: mobj_t, source: mobj_t, damagetype: int) => boolean, objecttype: int): nil
declare function addHook(hook: "MobjFuse",fn: (mobj: mobj_t) => boolean, objecttype: int): nil
declare function addHook(hook: "MobjMoveBlocked",fn: (mobj: mobj_t) => boolean, objecttype: int): nil
declare function addHook(hook: "MobjMoveCollide",fn: (tmthing: mobj_t, thing: mobj_t) => boolean, objecttype: int): nil
declare function addHook(hook: "MobjRemoved",fn: (mobj: mobj_t) => boolean, objecttype: int): nil
declare function addHook(hook: "MobjSpawn",fn: (mobj: mobj_t) => boolean, objecttype: int): nil
declare function addHook(hook: "MobjThinker",fn: (mobj: mobj_t) => boolean, objecttype: int): nil
...
declare function addHook(hook: "ShouldDamage",fn: (target: mobj_t, inflictor: mobj_t, source: mobj_t, damage: int, damagetype: int) => boolean, objecttype: int): nil
...
declare function addHook(hook: "TouchSpecial",fn: (special: mobj_t, toucher: mobj_t) => boolean, objecttype: int): nil
...
declare function userdataMetatable(userdataName: string): table_t
...
declare function G_AddGametype(t: table_t): nil
...
declare function P_CheckPosition(mobj: mobj_t, x: fixed_t, y: fixed_t): [boolean, mobj_t]
declare function P_TryMove(mobj: mobj_t, x: fixed_t, y: fixed_t, allowdropoff?: boolean): [boolean, mobj_t]
declare function P_Move(actor: mobj_t, speed: int): [boolean, mobj_t]
declare function P_TeleportMove(mobj: mobj_t, x: fixed_t, y: fixed_t, z: fixed_t): [boolean, mobj_t]
...
declare function P_ClosestPointOnLine(x: fixed_t, y: fixed_t, line: line_t): [fixed_t, fixed_t]
...
declare function R_Frame2Char(frame: int): [string, int]
...
declare function getfenv(f: Function | int): any // (environment)
declare function getmetatable(obj: object): any //  (metatable)
declare function ipairs(t: table_t): [int, any][]
declare function next(t: table_t, index: int): [int, any]
declare function pairs(t: table_t): [Function, table_t, nil]
declare function pcall(fn: Function, ...arg: any): [boolean, (unknown | string)]
declare function rawequal(v1: any, v2: any): boolean
declare function rawget(t: table_t, index: any): any
declare function rawset(t: table_t, index: any, value: any): table_t
declare function select(...index: any): unknown[] | int
declare function setfenv(f: Function | int, table: table_t): Function
declare function setmetatable(t: table_t, metatable: table_t): table_t
declare function tonumber(e: any, base: int): int | nil
declare function tostring(e: any): string
declare function type(v: any): string
declare function unpack(list: table_t, start: int, end: int): unknown[]
declare function xpcall(call: Function,errortrap: (status: boolean) => void): [boolean, (unknown | string)]

declare type thread = unknown

declare namespace coroutine
{
    export function create(fn: Function): thread
    export function resume(co: thread, ...val: any[]): [boolean, any]
...
declare namespace string
{
    ...
    export function find(s: string, pattern: string, start: int, plain?: boolean): [int, int, string]
    ...
    export function match(s: string, patternintn: string): string
